  ...
  return (
    <div className='section' id='courses'>
      <div className='text-center'>
        ...
        <p className='text-sm text-gray leading-7 max-w-[700px] mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni rerum laborum quibusdam, commodi, placeat minus odio dolores quam officia fugiat, impedit corrupti cum! Rerum nisi aspernatur itaque cum, temporibus voluptas. Lorem ipsum dolor sit amet.</p>
      </div>
      <motion.div
        variants={container}
        initial='hidden'
