    ...
    >
      <div className='grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white'>
        <div>
          ...
          <p className='text-sm leading-7'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas pariatur aliquid quae? Exercitationem nihil pariatur, iste perspiciatis tempore cumque quo.</p>
        </div>
        <div>
          <div className='font-bold mb-6'>
            Services
          ...
          <div className='flex flex-col gap-4'>
            ...
            <a href="" className='text-sm hover:underline'>Web Developer</a>
