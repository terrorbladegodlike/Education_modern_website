  ...
  return (
    <div className='section' id='contact'>
      <div className='text-center max-w-[600px] mx-auto'>
        ...
        <p className='text-sm leading-7 text-gray'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur veniam consectetur sit porro corrupti soluta minima provident, impedit delectus quas.</p>
        <motion.form 
          initial={{scale: 0}}
          whileInView={{scale: 1}}
