...
const NavBar = () => {
  ...
  return (
    <div className={`${active ? "shalow-gl bg-Solitude" : ""} fixed w-full top-0 left-0 z-20`}>
      <div>
        <div className={`${active ? "py-2 transition-all duration-300" : "py-4"} container py-4 mx-auto flex items-center justify-between px-2'`}>
          ...
          {toggle && (
            <motion.div
              ...
              className='fixed w-full h-full top-0 left-0 z-20 bg-Teal text-white flex flex-col justify-center items-center shadow-lg gap-8 py-8'
            >
              {navLinks.map(navLink => {
